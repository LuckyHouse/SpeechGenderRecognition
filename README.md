...
You can export the current file by clicking **Export to disk** in the menu. You can choose to eort the file as plain Markdown, as HTML using a Handlebars template or as a PDF.
